...
class RadioButtonPage(BasePage):
    ...
    def click_in_the_radio_button(self, choice):
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_file_name = rf'C:\Users\Админ\Desktop\automation_qa\filetest{random.randint(0, 999)}.jpg'
...
class DynamicPropirtiesPage(BasePage):

    locators = DynamicPropirtiesPageLocators()
