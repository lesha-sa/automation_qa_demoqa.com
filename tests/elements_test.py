...
from pages.elements_page import TextBoxPage, CheckBoxPage, RadioButtonPage, WebTablePage, ButtonsPage, LinksPage, \
    UploadAndDownloadPage, DynamicPropirtiesPage
import time
...
class TestElements:
    class TestTextBox:
        ...
        def test_text_box(self, driver):
            ...
            assert full_name == output_name, "error full_name"
            assert email == output_email, "error email"
            assert current_address == output_cur_addr, "error current_address"
            assert permanent_address == output_per_addr, "error permanent_address"
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_dynamic_properties(self, driver):
            dynamic_properties_page = DynamicPropirtiesPage(driver, 'https://demoqa.com/dynamic-properties')
        ...
        def test_appear_button(self,driver):
            ...
            assert appear is True, "button did not appearafter 5 second"

        def test_enable_button(self, driver):
            dynamic_properties_page = DynamicPropirtiesPage(driver, 'https://demoqa.com/dynamic-properties')
            dynamic_properties_page.open()
            enable = dynamic_properties_page.check_enable_button()
            assert enable is True, " botton did not enable after 5 second"
